...
/**
 * Default display name for AI auto-generated tracks — always includes the
 * language code alongside "Auto-generated" (e.g. "Auto-generated (en)").
 */
export function buildAutoGeneratedLabel(language?: string | null): string {
  const lang = normalizeSubtitleLanguage(language || "en");
  return `Auto-generated (${lang})`.slice(0, 80);
}
