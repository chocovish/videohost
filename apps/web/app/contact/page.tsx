...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden flex flex-col justify-between selection:bg-primary/30">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-xl sm:w-200 h-144 sm:h-200 bg-primary opacity-15 blur-3xl rounded-full pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[20rem] h-80 bg-emerald-500 opacity-10 blur-3xl rounded-full pointer-events-none" />
      ...
      <main className="max-w-6xl w-full mx-auto px-4 sm:px-6 py-10 sm:py-16 relative z-10 flex-1 space-y-10 sm:space-y-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1: Phone */}
          <div className="glass-card p-6 sm:p-8 rounded-3xl border border-border space-y-4 hover:border-primary/50 transition-all group shadow-lg">
            ...
            <div className="pt-2 space-y-2">
              <a
                ...
                className="text-base sm:text-lg font-extrabold text-foreground hover:text-primary transition-colors block"
              >
                +91 7278765456
              </a>
          ...
          <div className="glass-card p-6 sm:p-8 rounded-3xl border border-border space-y-4 hover:border-emerald-500/50 transition-all group shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="glass-card p-5 rounded-2xl border border-border space-y-2">
              <h4 className="font-bold text-sm flex items-center gap-2">
                <HelpCircle className="w-4 h-4 text-primary" /> How much free storage do I get?
              </h4>
            ...
            <div className="glass-card p-5 rounded-2xl border border-border space-y-2">
              <h4 className="font-bold text-sm flex items-center gap-2">
                <HelpCircle className="w-4 h-4 text-primary" /> How does email access restriction work?
              </h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="glass-card p-5 rounded-2xl border border-border space-y-2">
              <h4 className="font-bold text-sm flex items-center gap-2">
                <HelpCircle className="w-4 h-4 text-primary" /> Can I request a refund if I upgrade?
              </h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="glass-card p-5 rounded-2xl border border-border space-y-2">
              <h4 className="font-bold text-sm flex items-center gap-2">
                <HelpCircle className="w-4 h-4 text-primary" /> How do I cancel my subscription?
              </h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
