      ...
      <main className="max-w-4xl w-full mx-auto px-4 sm:px-6 py-10 sm:py-16 relative z-10 flex-1 space-y-8 sm:space-y-12">
        ...
        <div className="glass-card p-6 sm:p-10 rounded-3xl border border-border shadow-xl space-y-8 text-sm leading-relaxed">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-primary/10 border border-primary/20 flex items-start gap-3 text-xs sm:text-sm">
            ...
            <div>
              <p className="font-semibold text-foreground">Your Privacy Matters to Us</p>
          ...
          <section className="space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="text-lg font-bold tracking-tight flex items-center gap-2">
                <Eye className="w-4 h-4 text-primary" /> Information We Collect
              </h2>
            </div>
            <div className="pl-10 space-y-2 text-muted-foreground">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li><strong className="text-foreground">Account Information:</strong> Your email address, name, and hashed authentication credentials.</li>
                <li><strong className="text-foreground">Video & Media Data:</strong> Videos, thumbnails, titles, and metadata uploaded to your account.</li>
                <li><strong className="text-foreground">Access Control Settings:</strong> Restricted email lists and passcode settings configured for video playback.</li>
                <li><strong className="text-foreground">Technical Logs:</strong> IP address, browser type, and playback telemetry for queue processing and analytics.</li>
              </ul>
            </div>
          </section>
          ...
          <section className="space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="text-lg font-bold tracking-tight flex items-center gap-2">
                <Cookie className="w-4 h-4 text-primary" /> Cookies & Local Storage
              </h2>
            </div>
            <p className="text-muted-foreground pl-10">
          ...
          <section className="space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="text-lg font-bold tracking-tight flex items-center gap-2">
                <UserX className="w-4 h-4 text-primary" /> Your Rights & Account Deletion
              </h2>
            </div>
            <p className="text-muted-foreground pl-10">
