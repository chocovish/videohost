...
const STARTER_OFFERINGS = [
  ...
  {
    type: "MEETING",
    title: "1:1 Architecture & Technical Mentorship Call",
    subtitle: "Direct 45-minute live consultation & system review",
    description: "Deep dive into your project architecture, code bottlenecks, cloud streaming pipeline, or tech career roadmap with tailored 1-on-1 actionable advice.",
    price: "$120",
    pricePeriod: "/ 45 mins",
    ...
    highlights: [
      ...
      "Follow-up QA Email Support",
    ],
    meetingDuration: "45 mins",
    deliveryFormat: "Live 1:1 Video Meeting",
    order: 1,
    isFeatured: true,
    isPublished: true,
  },
