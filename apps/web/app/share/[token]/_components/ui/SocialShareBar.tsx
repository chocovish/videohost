...
/** X / LinkedIn / WhatsApp share row. Renders nothing unless `showSocialBar`. */
export function SocialShareBar({ theme }: SocialShareBarProps) {
  const { config, dividerBorder, mutedText, shareUrl, shareTitle } = theme;
  const isLight = theme.isLight;

  if (!config.showSocialBar) return null;
