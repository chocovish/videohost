      ...
      <main className="max-w-4xl w-full mx-auto px-4 sm:px-6 py-10 sm:py-16 relative z-10 flex-1 space-y-8 sm:space-y-12">
        ...
        <div className="glass-card p-6 sm:p-10 rounded-3xl border border-border shadow-xl space-y-8 text-sm leading-relaxed">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-primary/10 border border-primary/20 flex items-start gap-3 text-xs sm:text-sm">
            ...
            <div>
              <p className="font-semibold text-foreground">7-Day Money-Back Guarantee</p>
          ...
          <section className="space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="text-lg font-bold tracking-tight flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-primary" /> Refund Eligibility Criteria
              </h2>
            </div>
            <div className="pl-10 space-y-2 text-muted-foreground">
              <p>Refunds are eligible under the following conditions:</p>
              <ul className="list-disc pl-5 space-y-1">
                <li><strong className="text-foreground">First-Time Subscription Upgrade:</strong> Refund requests submitted within 7 calendar days of your initial paid plan activation.</li>
                <li><strong className="text-foreground">Billing Errors or Duplicate Charges:</strong> Erroneous double charges or inadvertent overbilling will be refunded 100% upon verification.</li>
                <li><strong className="text-foreground">Unresolved Technical Faults:</strong> Extended unexpected platform downtime preventing video streaming or processing.</li>
              </ul>
            </div>
          </section>
          ...
          <section className="space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="text-lg font-bold tracking-tight flex items-center gap-2">
                <Clock className="w-4 h-4 text-primary" /> Processing Timeline
              </h2>
            </div>
            <p className="text-muted-foreground pl-10">
              Once your refund request is approved, the refund will be initiated immediately. Credits will automatically be processed back to your original payment method (via Razorpay / Debit Card / Credit Card / Netbanking / UPI) within <strong className="text-foreground">5 to 7 business days</strong>.
            </p>
          </section>
          ...
          <div className="pt-6 border-t border-border space-y-3">
            <h3 className="text-base font-bold flex items-center gap-2">
              <HelpCircle className="w-4 h-4 text-primary" /> How to Request a Refund
            </h3>
            <p className="text-xs sm:text-sm text-muted-foreground">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
              <a
                ...
                className="p-4 rounded-2xl bg-black/5 dark:bg-white/5 border border-border hover:border-primary transition-all flex flex-col items-start gap-1"
              >
                <div className="flex items-center gap-2 text-xs font-bold text-primary">
                  <Mail className="w-4 h-4" /> Email Support
                </div>
                <span className="text-xs font-semibold">support@taped.in</span>
                <span className="text-[11px] text-muted-foreground">Fast response within 24h</span>
              </a>
              ...
              >
                ...
                <span className="text-[11px] text-muted-foreground">Mon-Sat, 9 AM - 7 PM IST</span>
              </a>
