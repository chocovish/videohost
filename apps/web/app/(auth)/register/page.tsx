...
import { Video, ArrowRight, Building2, Sparkles } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[hsl(var(--background))] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg glass-card rounded-2xl p-8 shadow-2xl relative z-10 border border-[hsl(var(--border))]">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-[hsl(var(--foreground))]">Create your Video Host Account</h1>
          <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">
            Start streaming in minutes with 200 free stored video minutes
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? "Creating organization..." : "Get Started Free"}
