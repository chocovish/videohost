...
import { Users, UserPlus, HardDrive, Shield, Sparkles, Check, AlertCircle } from "lucide-react";
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-[hsl(var(--muted-foreground))]">
          Manage team permissions, role-based access, and custom storage limits
        </p>
      </div>
