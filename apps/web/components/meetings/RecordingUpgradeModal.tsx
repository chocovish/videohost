...
export default function RecordingUpgradeModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent
        className="p-0 overflow-hidden shadow-2xl backdrop-blur-2xl max-w-lg z-70 max-h-[90vh] flex flex-col"
      >
        {/* Header with decorative glowing background */}
        <div className="relative p-6 pb-5 border-b border-border bg-gradient-to-b from-rose-500/10 via-muted/40 to-background overflow-hidden shrink-0">
          ...
          <div className="relative z-10 flex items-start gap-4">
            ...
            <div className="space-y-1 min-w-0 flex-1">
              ...
              <DialogTitle className="text-lg font-bold tracking-tight pt-0.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            <div className="p-3 rounded-xl bg-muted/50 border border-border flex items-start gap-2.5">
              ...
              <div className="text-xs">
                <span className="font-semibold text-foreground block">Full Grid & PiP Layouts</span>
                <span className="text-[11px] text-muted-foreground">Record room or Screen + Camera PiP</span>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-muted/50 border border-border flex items-start gap-2.5">
              ...
              <div className="text-xs">
                <span className="font-semibold text-foreground block">Auto Cloud Storage</span>
                <span className="text-[11px] text-muted-foreground">Saved directly to your video library</span>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-muted/50 border border-border flex items-start gap-2.5">
              ...
              <div className="text-xs">
                <span className="font-semibold text-foreground block">Instant Video Playback</span>
                <span className="text-[11px] text-muted-foreground">Shareable links & video player</span>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-muted/50 border border-border flex items-start gap-2.5">
              ...
              <div className="text-xs">
                <span className="font-semibold text-foreground block">Higher Limits & Seats</span>
                <span className="text-[11px] text-muted-foreground">Up to 4K quality & team collaboration</span>
              </div>
            </div>
          </div>
        ...
        {/* Footer Actions */}
        <DialogFooter className="p-4 sm:p-6 pt-3 border-t border-border bg-muted/40 shrink-0 flex flex-col sm:flex-row items-center justify-between sm:justify-between gap-3">
          <Button
            type="button"
            variant="ghost"
            size="sm"
