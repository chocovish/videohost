            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all overflow-hidden ${
                  isOpen
                    ? "bg-white dark:bg-slate-900 border-primary/50 shadow-lg"
                    : "bg-white/60 dark:bg-slate-900/40 border-border hover:border-primary/30"
                }`}
              >
                <button
                ...
                >
                  ...
                  <div
                    className={`p-1.5 rounded-xl border transition-transform duration-200 shrink-0 ${
                      isOpen
                        ? "rotate-180 bg-primary text-white border-transparent"
                ...
                {isOpen && (
                  <div className="px-5 sm:px-6 pb-6 pt-1 text-xs sm:text-sm text-muted-foreground leading-relaxed border-t border-border/50 animate-in fade-in duration-150">
                    {item.answer}
                  </div>
                )}
              </div>
