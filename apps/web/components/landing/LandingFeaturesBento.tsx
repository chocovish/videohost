    ...
    <section className="w-full py-16 sm:py-24 relative overflow-hidden" id="features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs font-black uppercase tracking-wider">
          ...
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-foreground">
            ...
            <span className="text-primary">Zero external tools required.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="md:col-span-7 rounded-3xl border border-border bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 flex flex-col justify-between space-y-6 glow-card-hover group relative overflow-hidden">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-primary/15 text-primary text-[11px] font-black uppercase tracking-wide">
            ...
            {/* Visual Mini Mockup */}
            <div className="rounded-2xl border border-border bg-slate-950 p-4 text-white space-y-3 shadow-lg relative z-10">
            ...
            <div className="flex items-center gap-4 text-xs font-bold text-primary pt-2">
          ...
          <div className="md:col-span-5 rounded-3xl border border-border bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 flex flex-col justify-between space-y-6 glow-card-hover group relative overflow-hidden">
            <div className="space-y-3 relative z-10">
            ...
            <div className="rounded-2xl border border-border bg-slate-50 dark:bg-slate-950 p-4 space-y-2 text-xs">
              ...
              <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-border flex items-center justify-between">
                <span className="font-mono text-[11px] text-foreground">partner@enterprise.com</span>
                <span className="text-[9px] px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-500 font-bold">PIN Gated</span>
              </div>
              <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-border flex items-center justify-between">
                <span className="font-mono text-[11px] text-foreground">exec-board@client.io</span>
                <span className="text-[9px] px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-500 font-bold">PIN Gated</span>
              </div>
            </div>
          ...
          <div className="md:col-span-4 rounded-3xl border border-border bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 flex flex-col justify-between space-y-6 glow-card-hover group">
            ...
            <div className="flex flex-wrap gap-1.5">
              <span className="px-2 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-[11px] font-bold text-foreground">
                2GB Free Forever
              </span>
              <span className="px-2 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-[11px] font-bold text-foreground">
                Zero Egress Fees
              </span>
              <span className="px-2 py-1 rounded-lg bg-primary/15 text-primary text-[11px] font-extrabold">
                Fast S3 Upload
              </span>
            </div>
          </div>
          ...
          <div className="md:col-span-4 rounded-3xl border border-border bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 flex flex-col justify-between space-y-6 glow-card-hover group">
            ...
            <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-border space-y-1 text-xs">
              <div className="flex items-center justify-between font-bold text-foreground">
                <span>Course Modules (4 Videos)</span>
                <span className="text-[10px] text-primary">Embed Ready</span>
              </div>
              <p className="text-[10px] text-muted-foreground">Share as single URL or iframe player</p>
            </div>
          </div>
          ...
          <div className="md:col-span-12 rounded-3xl border border-border bg-linear-to-r from-slate-900 via-zinc-900 to-slate-950 text-white p-6 sm:p-10 flex flex-col lg:flex-row items-center justify-between gap-8 glow-card-hover relative overflow-hidden">
