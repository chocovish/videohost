      ...
      {isMobileOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          <div
            ...
            onClick={closeMobile}
          />
          <aside className="fixed inset-y-0 left-0 w-72 max-w-[85vw] bg-sidebar text-sidebar-foreground border-r border-border z-50 animate-in slide-in-from-left duration-300 overflow-y-auto shadow-2xl">
